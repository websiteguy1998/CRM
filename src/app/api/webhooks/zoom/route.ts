 ...
 * app, and ongoing `phone.call_log_completed` events for automatic call
 * sync (see src/lib/integrations/zoom.ts for the click-to-call half).
 */
export async function POST(req: NextRequest) {
  ...
  if (payload.event === "phone.call_log_completed") {
