...
const TYPES = [
  ...
  },
  {
    ...
    title: "Zoom Phone",
    description:
      "Server-to-Server OAuth app — click-to-call plus automatic call logging. After saving, add this webhook URL in your Zoom Marketplace app's Event Subscriptions: /api/webhooks/zoom on this site's domain — subscribe to whichever call-completed event it offers (\"Call Log Completed\" or \"Call History Completed\", caller and callee) — and paste the Secret Token it gives you into the field below.",
  },
  {
    type: "GMAIL" as const,
